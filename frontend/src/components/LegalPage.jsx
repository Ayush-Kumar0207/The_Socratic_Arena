...
const policies = {
  terms: {
    ...
    sections: [
      ...
      ['Subscriptions', 'Paid plans renew for the selected interval until cancelled. Price, currency, tax treatment, provider, allowance, and renewal timing are shown before checkout. India checkout may be handled by Razorpay; international checkout may be handled by Paddle. The selector previews regional prices; the server and payment provider confirm eligibility and billing country before access is activated.'],
  ...
  privacy: {
    ...
    sections: [
      ...
      ['Voice Pro recordings', 'When you record in Voice Pro, acoustic measurements are calculated in your browser. Raw audio is not uploaded by this workflow. The approved transcript, duration, derived measurements, and coaching result may be stored with your account so you can review your history.'],
